...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.dealer-categories.store") }}" onSubmit="return confirm('Please verify your colors and addons before submit.')" method="POST" enctype="multipart/form-data">
            @csrf
