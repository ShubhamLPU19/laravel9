...
.top_rw{ background-color:#f4f4f4; }
    ...
    <div style="max-width: 700px; width: 100%; margin: 0 auto;">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            @if(strtolower($dds->state_name) == "bihar")
            <tr class="item">
               <td style="width:25%;"> <b>  </b> </td>
				<td style="width:10%; text-align:center;">
                ...
                <td style="width:10%; text-align:right;">
				 ...
				 <td style="width:15%; text-align:right;">
                    {{number_format(($total_amount * 9)/100,2)}}
                </td>
            </tr>
            <tr class="item">
               <td style="width:25%;"> <b>  </b> </td>
            ...
            <tr class="item">
               <td style="width:25%;"> <b>  </b> </td>
                ...
                <td style="width:10%; text-align:right;">
				 ...
				 <td style="width:15%; text-align:right;">
                    {{number_format(($total_amount * 18)/100,2)}}
                </td>
            </tr>
            @endif
            <tr class="item">
               <td style="width:25%;"> <b> GROSS TOTAL  </b> </td>
                ...
                <td style="width:10%; text-align:right;">
				 ...
				 <td style="width:15%; text-align:right;">
                    @if(strtolower($dds->state) == "bihar") {{$total_amount + $igst}}  @else {{$total_amount + ($sgst + $cgst)}} @endif
                </td>
            </tr>
			</table>
            <tr class="total">
