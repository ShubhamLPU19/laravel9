    ...
    <div class="card-header">
        Product Management
         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product_create')): ?>
            <a class="btn btn-success" style="float:right;" href="<?php echo e(route("admin.products.create")); ?>">
                Add Product
            </a>
        <?php endif; ?>
    </div>
...
<?php endif; ?>
  ...
  let dtOverrideGlobals = {
    ...
    aaSorting: [],
    ajax: {
      url: "<?php echo e(route('admin.products')); ?>",
      data: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\service-sangam\resources\views/dealer/product/index.blade.php ENDPATH**/ ?>