    ...
    <div class="card-body">
        <form action="<?php echo e(route("admin.categories.store")); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group <?php echo e($errors->has('color') ? 'has-error' : ''); ?>">
                ...
                <input type="text" id="color" name="color" class="form-control colorpicker" value="<?php echo e(old('color', isset($category) ? $category->color : '')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\service\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>