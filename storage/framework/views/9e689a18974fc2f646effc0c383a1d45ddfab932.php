    ...
    <div class="card-header">
        Dealer Category Management
         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product_create')): ?>
            <a class="btn btn-success" style="float:right;" href="<?php echo e(route("admin.dealer-categories.create")); ?>">
                Add Dealer Category
            </a>
        <?php endif; ?>
    </div>
...
<?php endif; ?>
  ...
  let dtOverrideGlobals = {
    ...
    aaSorting: [],
    ajax: {
      url: "<?php echo e(route('admin.dealer-categories')); ?>",
      data: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\service-sangam\resources\views/dealer/dealer_category/index.blade.php ENDPATH**/ ?>