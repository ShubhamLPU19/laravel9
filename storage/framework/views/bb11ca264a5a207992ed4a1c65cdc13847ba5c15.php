    ...
    <div class="card-body">
        <form action="<?php echo e(route("admin.users.store")); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group <?php echo e($errors->has('mobile') ? 'has-error' : ''); ?>">
                ...
                <input type="tel" maxlength="10" id="mobile" name="mobile" class="form-control" value="<?php echo e(old('mobile', isset($user) ? $user->mobile : '')); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\service-sangam\resources\views/admin/users/create.blade.php ENDPATH**/ ?>