...
<?php endif; ?>
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($editAttributeGroupingGate)): ?>
    <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.' . $crudRoutePart . '.editgroup', $row->id)); ?>">
        Edit Attribute
    </a>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH E:\service-sangam\resources\views/partials/datatablesActions.blade.php ENDPATH**/ ?>